    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('professional', 'Profissional'), ('contractor', 'Contratante'), ('both', 'Ambos')], default='both', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(blank=True, max_length=100)),
                ('state', models.CharField(blank=True, max_length=2)),
                ('availability', models.CharField(choices=[('available', 'Disponivel'), ('busy', 'Ocupado'), ('unavailable', 'Indisponivel')], default='available', max_length=20)),
